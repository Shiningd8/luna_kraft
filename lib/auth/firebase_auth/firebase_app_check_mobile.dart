// Mobile implementation for firebase_app_check
...
class FirebaseAppCheck {
  ...
  Future<void> activate({
    ...
    debugPrint('[MOBILE] FirebaseAppCheck.activate() called');
    return;
  }

  Future<void> setTokenAutoRefreshEnabled(bool isTokenAutoRefreshEnabled) async {
    debugPrint('[MOBILE] FirebaseAppCheck.setTokenAutoRefreshEnabled() called');
    return;
  }

  Future<AppCheckToken> getToken([bool forceRefresh = false]) async {
    debugPrint('[MOBILE] FirebaseAppCheck.getToken() called');
    return AppCheckToken(token: 'mobile-token', expireTimeMillis: 0);
  }
}
