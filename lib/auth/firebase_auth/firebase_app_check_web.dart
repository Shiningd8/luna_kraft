// Web implementation for firebase_app_check
...
class FirebaseAppCheck {
  ...
  Future<void> activate({
    ...
    debugPrint('[WEB] FirebaseAppCheck.activate() called');
    return;
  }

  Future<void> setTokenAutoRefreshEnabled(bool isTokenAutoRefreshEnabled) async {
    debugPrint('[WEB] FirebaseAppCheck.setTokenAutoRefreshEnabled() called');
    return;
  }

  Future<AppCheckToken> getToken([bool forceRefresh = false]) async {
    debugPrint('[WEB] FirebaseAppCheck.getToken() called');
    return AppCheckToken(token: 'web-token', expireTimeMillis: 0);
  }
}
